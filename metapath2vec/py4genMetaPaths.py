...
class MetaPathGenerator:
	...
	def generate_random_aca(self, outfilename, numwalks, walklength):
		...
		#fo = open("confout.txt", "w")

		#for k, v in self.conf_authorlist.items():
		...
		for conf in self.conf_authorlist:
			...
			if len(self.conf_authorlist[conf]) is not 0:
				conf0 = conf
...
#python py4genMetaPaths.py 1000 100 net_dbis   output2.dbis.w1000.l100.txt
#python py4genMetaPaths.py 1000 100 net_change2vec   output.net_change2vec.w1000.l100.txt
#python py4genMetaPaths.py 1000 100 net_dblp2011_classified   output.dblp2011-classified.w1000.l100.txt
#python py4genMetaPaths.py 1000 100 net_change2vec_classified   output.net_change2vec_classified.w1000.l100.txt
#python py4genMetaPaths.py 1000 100 change2vec_merge  output.change2vec_merge.w1000.l100.txt
#python py4genMetaPaths.py 1000 100 dblp2013  randomwalk.dblp2013.w1000.l100.txt
#python py4genMetaPaths.py 1000 100 dblp2010-2011-2013  randomwalk.dblp2010-2011-2013.w1000.l100.txt
#python py4genMetaPaths.py 1000 100 dblp2011-2013  randomwalk.dblp2011-2013.w1000.l100.txt

#dirpath = "net_aminer" 
# OR 
#dirpath = "net_dbis"
#dirpath = "net_change2vec"
#dirpath = "net_dblp2011_classified"
#dirpath = "net_change2vec_classified"
#dirpath = "change2vec_merge"
#dirpath = "dblp2013"
#dirpath = "dblp2010-2011-2013"
dirpath = "dblp2011-2013"
